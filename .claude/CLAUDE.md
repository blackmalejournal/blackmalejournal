...
<!-- .claude/CLAUDE.md generated by Extender on 20260428-153930 -->
...
- org: blackmalejournal
- risk_tier: highest
- default_action: halt
- require_approval_for: commit, push, force-push, ci_changes, secret_scans, deps
- block_on_blocker_findings: true
- never_auto_commit: true
- never_auto_push: true
- review_severity_floor: low
- secrets_scan_strictness: strict
- forbidden_paths: .github/**, .gitlab-ci.yml, Dockerfile, compose.*, **/.env*, **/secrets.*, **/credentials*, **/keys/**, deploy/**, infra/**
- default_workflow: bug-fix
- note: guest contributor — all edits go proposal→diff→review; never auto-commit or auto-push
