...
export function AdminMetricCard({
  ...
  const content = (
    <div
      className={`h-full border surface-panel p-6 transition-all duration-200 hover:-translate-y-0.5 hover:border-bmj-border-strong hover:shadow-md ${toneClasses[tone]}`}
    >
